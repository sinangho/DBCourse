...
CREATE TABLE `LogTable` (
  ...
  `user pwd` varchar(45) DEFAULT NULL,
  `login time` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `LogTable` VALUES (1,'jamesid','1234','2022-12-03-171022'),(2,'davidid','4324','2022-12-03-181022'),(3,'gerogeid','4567','2022-12-03-181125');
